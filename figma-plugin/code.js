  ...
  var defs = [
    {
      ...
      borderHex:  COLORS.borderInput,
      borderVar:  'color/borderInput',
      bgHex:      COLORS.surface,
      bgVar:      'color/surface',
      labelHex:   COLORS.textOnBrand,
    ...
    },
    {
      ...
      bgHex:      COLORS.surfaceLight,
      bgVar:      'color/surfaceLight',
      labelHex:   COLORS.neutral,
      textHex:    COLORS.neutral,
      disabled:   true,
    },
  ];
